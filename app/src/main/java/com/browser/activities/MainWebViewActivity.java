...
import com.browser.adapters.WebViewPagerAdapter;
import com.browser.asynctasks.GetHostIpAddresses;
import com.browser.asynctasks.PopulateBlocklists;
import com.browser.dialogs.AdConsentDialog;
import com.browser.dialogs.CreateBookmarkDialog;
import com.browser.dialogs.CreateBookmarkFolderDialog;
import com.browser.dialogs.CreateHomeScreenShortcutDialog;
import com.browser.dialogs.DownloadFileDialog;
import com.browser.dialogs.DownloadImageDialog;
import com.browser.dialogs.DownloadLocationPermissionDialog;
import com.browser.dialogs.EditBookmarkDialog;
import com.browser.dialogs.EditBookmarkFolderDialog;
import com.browser.dialogs.HttpAuthenticationDialog;
import com.browser.dialogs.SslCertificateErrorDialog;
import com.browser.dialogs.UrlHistoryDialog;
import com.browser.dialogs.ViewSslCertificateDialog;
import com.browser.fragments.WebViewTabFragment;
import com.browser.helpers.AdHelper;
import com.browser.helpers.BlocklistHelper;
import com.browser.helpers.BookmarksDatabaseHelper;
import com.browser.helpers.CheckPinnedMismatchHelper;
import com.browser.helpers.DomainsDatabaseHelper;
import com.browser.helpers.OrbotProxyHelper;
...
public class MainWebViewActivity extends AppCompatActivity implements CreateBookmarkDialog.CreateBookmarkListener, CreateBookmarkFolderDialog.CreateBookmarkFolderListener,
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        // Get the application's private data directory, which will be something like `/data/user/0/com.privacybrowser.standard`, which links to `/data/data/com.privacybrowser.standard`.
                                ...
                                if (event != Snackbar.Callback.DISMISS_EVENT_ACTION) {  // The snackbar was dismissed without the undo button being pushed.
                                    ...
                                    Runnable deleteDomStorageRunnable = () -> {
                                        try {
                                            ...
                                            // Get the application's private data directory, which will be something like `/data/user/0/com.privacybrowser.standard`,
                                            // which links to `/data/data/com.privacybrowser.standard`.
                                            String privateDataDirectoryString = getApplicationInfo().dataDir;
    ...
    private void initializeApp() {
        ...
        // Replace the header that `WebView` creates for `X-Requested-With` with a null value.  The default value is the application ID (com.privacybrowser.standard).
